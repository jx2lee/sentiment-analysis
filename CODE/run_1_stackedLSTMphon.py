...
if __name__=="__main__":
    ...
    Units=[128,128,128]
    keepProb = 0.5
    checkpointPath = './checkpoints/checkpoints_phonLSTM'
    npPath = './data/dataNp/phon/'
    path1 = 'X_phon.npz'
    path2 = 'y_phon.npz'
    pklName = '/result_LSTMphon.pkl'
    ...
    g = Build_stackedLSTMgraph(phon_size=features, state_size=unitSize, batch_size=batch_size, num_classes=numClasses, lstm_sizes=Units, keepProb_=keepProb)
